...
// 이전 호환성을 위한 별칭
export const KOREA_AIRPORTS = Object.fromEntries(
...
/**
 * 공항 정보 조회
 * @param {string} icao - ICAO 코드
 * @returns {Object|null} 공항 정보
 */
export const getAirportInfo = (icao) => {
 ...
 * 공항 이름 조회
 * @param {string} icao - ICAO 코드
 * @returns {string} 공항 이름 또는 ICAO 코드
 */
 ...
 */
export const getAirportCoordinates = (icao) => {
