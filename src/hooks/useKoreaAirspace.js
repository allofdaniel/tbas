 ...
 * @param {Object} koreaAirspaceData - Korea airspace data
 * @param {boolean} showKoreaRoutes - Show routes toggle
 * @param {boolean} showKoreaWaypoints - Show waypoints toggle
 * @param {boolean} showKoreaNavaids - Show navaids toggle
 * @param {boolean} showKoreaAirspaces - Show airspaces toggle
