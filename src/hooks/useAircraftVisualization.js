...
export default function useAircraftVisualization(
  ...
  }, [aircraft, aircraftTrails, showAircraft, showAircraftTrails, show3DAircraft, is3DView, show3DAltitude, mapLoaded, trailDuration, headingPrediction, selectedAircraft, labelOffset]);
}
